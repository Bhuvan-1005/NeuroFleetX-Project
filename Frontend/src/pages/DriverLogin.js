      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <h2>Driver Login</h2>
            <p>Access your routes and assigned tasks on NeuroFleetX</p>
          </div>
        ...
        <div className="auth-illustration">
          <div className="illustration-content">
            ...
            <ul>
              <li>
                <i className="fas fa-check"></i> View assigned routes
              </li>
              <li>
                <i className="fas fa-check"></i> Update trip status
              </li>
              <li>
                <i className="fas fa-check"></i> Real-time navigation assistance
              </li>
            </ul>
          </div>
        </div>
